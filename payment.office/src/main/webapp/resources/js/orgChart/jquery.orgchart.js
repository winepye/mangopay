    ...
    function Node(data){
        ...
        this.render = function(opts){
            ...
            if(childLength > 0){
                ...
                for(var i=0; i<list.length; i++){
                	mainTable += "<td colspan='2'>"+list[i].render(opts)+"</td>";
                }
                mainTable += "</tr>";
            }
            mainTable += '</table>';
        ...
        this.formatNode = function(opts){
            ...
            if(typeof data.name !== 'undefined'){            	
                ...
                descString = '<p>'+self.data.company+'</p>';
            }
            ...
            var nodeData;
            if( data.isStaff == 0 || data.isStaff == undefined ){
            	nodeData = "<div class='node' node-id='"+this.data.id+"'>"+nameString+descString+buttonsHtml+"</div>";
            }
            else{
            	nodeData = "<div class='node node_staff' node-id='"+this.data.id+"'>"+nameString+descString+buttonsHtml+"</div>";
            }
