...
function fn_doCreatePopup(){
	...
	$("#frm").attr("action",contextRoot + "/admin/popup/popup/createPopupAjax.do");
	commonAjaxSubmit("POST", $("#frm"), fn_doCreatePopupCallback);
}
//저장 콜백
function fn_doCreatePopupCallback(data){
