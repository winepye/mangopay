...
<script type="text/javascript">
    ...
    function fn_createShop(){
        ...
        var shopTelNum;
        telNum = $("#shopTelNum1").val()+"-"+$("#shopTelNum2").val()+"-"+$("#shopTelNum3").val();
        $("#shopTelNum").val(shopTelNum);


        if(confirm("<spring:message code='request.common.save'   />")) {
            $("#frm").attr("action",contextRoot + "/admin/shop/createShopAjax.do");
...
<div id="pop_wrap">
    ...
    <div class="pop_container">
        ...
        <form id = "frm" name = "frm" method="post">
            <h3 class="h2_table_title">매장 등록</h3>
            <table id="templateProject" class="tb_left_st2">
                ...
                <tbody>
                    <tr>
                        <th scope="row"><label><span class="redstar">*</span>고객사</label></th>
                        <td>
                        ...
                        <th scope="row"><label><span class="redstar">*</span>브랜드</label></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="input_s_b w100pro" id="shopName" name="shopName" onkeyup="chkword(this, 30)">
                        </td>
                        <th scope="row"><label><span class="redstar">*</span>매장관리코드</label></th>
                        <td>
                            <input type="text" class="input_s_b w100pro" id="shopMngCode" name="shopMngCode" onkeyup="chkword(this, 30)">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="shopTelNum1" name="shopTelNum1" class="input_s_b w30pro" onkeyup="chkword(this, 3,'shopTelNum2')" numberOnly/>
                            <label class="w5pro">-</label>
                            <input id="shopTelNum2" name="shopTelNum2" class="input_s_b w30pro" onkeyup="chkword(this, 4,'shopTelNum3')" numberOnly/>
                            <label class="w5pro">-</label>
                            <input id="shopTelNum3" name="shopTelNum3" class="input_s_b w30pro" onkeyup="chkword(this, 4)" numberOnly/>
                        </td>
            ...
            <div class="bs_BtnBox_c">
                <button type="button" id="btnCreate" class="btn_gray_B01" onclick="fn_createShop()">저장</button>
