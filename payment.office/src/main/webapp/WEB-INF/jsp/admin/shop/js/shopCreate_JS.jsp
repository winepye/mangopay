...
<script type="text/javascript">
    ...
    function fn_doCreatePay(){
        ...
        if(confirm("<spring:message code='request.common.save'   />")) {
            $("#frm").attr("action",contextRoot + "/admin/payService/createPayServiceAjax.do");
            commonAjaxSubmit("POST", $("#frm"), fn_doCreatePayCallback);
        }
    ...
    //저장 콜백
    function fn_doCreatePayCallback(data){
