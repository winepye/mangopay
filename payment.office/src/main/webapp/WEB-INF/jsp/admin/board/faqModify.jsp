...
<%@ include file="./js/faqModify_JS.jsp"%>
<!--
...
<section id="detail_contents">
	<form id = "frm" name = "frm" method="post">
		...
		<h3 class="h2_table_title">FAQ 수정</h3>
           ...
           <tbody>
               <tr>
                   ...
                   <td>
                   		<input id="title" name="title" class="input_s_b w100pro" maxlength="100" placeholder="제목을 입력하세요." value="<c:out value="${faqBoardVo.title }" />"/>
                   </td>
               </tr>
               <tr>
                   <th scope="row"><label for="categCd"><span class="redstar">*</span>FAQ유형</label></th>
                   <td>
                        <customTagUi:code type="select" cdGrp="FAQ_CATEG_CD" name="categCd" id="categCd" cd="${faqBoardVo.categCd}" attr='class="sel_basic w200px"' subjectText="선택"/>
                   </td>
               </tr>
               <tr>
                   ...
                   <td>
                   		...
                   		<input type="hidden" id = "content" name = "content" value="<c:out value="${faqBoardVo.content }" />">
                   </td>
               </tr>
               <tr>
                   <th scope="row">노출여부</th>
                   <td class="itemList">
                   		<customTagUi:code type="radio" cdGrp="YN_COMMON" name="openYn" id="openYn" cd="${faqBoardVo.openYn }" prefix="<span>" postfix="</span>"/>
                   </td>
               </tr>
           </tbody>
       </table>
		...
		<div class="bs_BtnBox_c">
            ...
            <button type="button" id="btnModifyFaq" class="btn_gray_B01">저장</button>
        </div>
		<!-- 버튼 -->
