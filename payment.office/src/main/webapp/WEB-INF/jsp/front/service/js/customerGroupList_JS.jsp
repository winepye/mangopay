...
<script type="text/javascript" defer="defer">
	...
	function getCustomerGroupDetail(customerGroupId){
		...
		if(typeof isGroupDetailChg !=  'undefined' && isGroupDetailChg){
			if(!confirm("사용자 수정사항이 초기화됩니다. 계속하시겠습니까?")) return;
		}

		var url = "/service/userGroup/getCustomerGroupDetailAjax.do";
