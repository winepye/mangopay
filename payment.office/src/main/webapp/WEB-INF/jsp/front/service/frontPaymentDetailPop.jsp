...
<%@ include file="./js/frontPaymentDetailPop_JS.jsp"%>
<div id="pop_wrap">
    ...
    <div class="pop_container">
        ...
        <table class="board_popview_st01" summary="승인이력상세">
            ...
            <tr>
                ...
                <td>${payDetail.processStatusName }</td>
            </tr>
            <tr>
                <th scope="row">발급사</th>
            ...
            <tr>
                ...
                <td>${payDetail.payUserName }</td>
                <th scope="row">전화번호</th>
                <td>${payDetail.mobileNo }</td>
            </tr>
            <tr>
                <th scope="row">청구사유</th>
                <td colspan="3">${payDetail.requestReason }</td>
            </tr>
