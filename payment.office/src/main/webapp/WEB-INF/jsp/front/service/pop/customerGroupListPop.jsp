...
<%@ include file="../js/customerGroupListPop_JS.jsp"%>
<!--
...
<div class="pop_titleZone">
    <h1 class="title">사용자그룹</h1>
    <button type="button" class="btn_popclose closePop" id = "closeCustomerPop"><em>닫힘</em></button>
</div>
<div class="pop_container" id = "customerGroupPopArea">
		        ...
		        <article>
		        	<form id="groupFrm" name = "groupFrm">
						...
						<div id = "customerGroupListArea">
							<div id="includeArea">
								<jsp:include page="../include/customerGroupListPop_INC.jsp"></jsp:include>
							</div>
						</div>
					  </form>
	             </article>
		...
		<div class="step_detailview">
		    ...
		    <div class="detailviewBox">
		        <article id = "customerGroupDetailArea">
		        	<jsp:include page="../include/customerGroupDetailPop_INC.jsp"></jsp:include>
	             </article>
		    </div>
		</div>
