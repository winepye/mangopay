...
<!doctype html>
<html lang="ko">
<script type="text/JavaScript" src="/report/resources/js/join_kr.js"></script>
<body>
	<div id="wrap">
        <!--header-->
    	...
    	<div id="main_container">
			<!-- content -->
			<div id="main_content">
				<h2 class="blind">간편결제 회원가입</h2>
				<div class="join_content">
					<!-- 약관동의 -->


					<h3 class="joinTitleStyle">약관동의</h3>
					<div class="terms_p">
					  ...
					  <p class="terms_chk_all">
						  <span class="input_chk">
						    ...
						    <label id="chk_allLb" for="chk_all" class="all_check">이용약관및 개인정보 수집 및 이용에 모두 동의 합니다</label>
						  </span>
					  </p>
					  <!--//전체선택//-->
					  ...
					  <ul id="termsDiv" class="terms_bx_list" style="display:block" >
					    ...
					    <span class="input_chk">
					      ...
					      <label id="termsServiceLb" for="termsService">이용약관동의<span class="terms_choice">(필수)</span></label>
					      <button type="button" class="btnStyle termsBtn" onClick="termsBtn(this);">약관닫기</button>
					    </span>
					      ...
					      <div class="terms_box" id="terms_box">
					        <!-- 이용약관 동의내용 -->
					        <div class="article">
					          <h4 class="article__title">제 1 조 (목적)</h4>
					        ...
					        <div class="article">
					          <h4 class="article__title">제 2 조 (정의)</h4>
					        ...
					        <div class="article">
					          <h4 class="article__title">제 3 조 (약관의 게시와 개정)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 4 조 (약관의 해석)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 5 조 (이용계약 체결)</h4>
					          <ol class="sections">
					            ...
					            <li class="sections__section">②"회사"는 "가입신청자"의 신청에 대하여 "서비스" 이용을 승낙함을 원칙으로 합니다. 다만, "회사"는 다음 각 호에 해당하는 신청에 대하여는 승낙을 하지 않거나 사후에 이용계약을 해지할 수 있습니다.
					              <ol class="sections">
					                <li class="sections__section">1.	1.가입신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 단 "회사"의 회원 재가입 승낙을 얻은 경우에는 예외로 함. </li>
					                <li class="sections__section">2.	2.실명이 아니거나 타인의 명의를 이용한 경우 </li>
					                <li class="sections__section">3.	3.허위의 정보를 기재하거나, "회사"가 제시하는 내용을 기재하지 않은 경우 </li>
					                <li class="sections__section">4.	4.14세 미만 아동이 법정대리인(부모 등)의 동의를 얻지 아니한 경우 </li>
					                <li class="sections__section">5.	5.이용자의 귀책사유로 인하여 승인이 불가능하거나 기타 규정한 제반 사항을 위반하며 신청하는 경우 </li>
					              </ol>
					            </li>
					        ...
					        <div class="article">
					          <h4 class="article__title">제 6 조 (회원정보의 변경)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 7 조 (개인정보보호 의무)</h4>
					          <p class="article__text">"회사"는 "정보통신망법" 등 관계 법령이 정하는 바에 따라 "회원"의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법 및 "회사"의 개인정보취급방침이 적용됩니다. 다만, "회사"의 공식 사이트 이외의 링크된 사이트에서는 "회사"의 개인정보취급방침이 적용되지 않습니다.</p>
					        </div>
					        <div class="article">
					          <h4 class="article__title">제 8 조 ("회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 9 조 ("회원"에 대한 통지)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 10 조 ("회사"의 의무)</h4>
					          <ol class="sections">
					            <li class="sections__section">①"회사"는 관련법과 이 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 계속적이고 안정적으로 "서비스"를 제공하기 위하여 최선을 다하여 노력합니다. </li>
					            <li class="sections__section">②"회사"는 "회원"이 안전하게 "서비스"를 이용할 수 있도록 개인정보(신용정보 포함)보호를 위해 보안시스템을 갖추어야 하며 개인정보취급방침을 공시하고 준수합니다. </li>
					        ...
					        <div class="article">
					          <h4 class="article__title">제 11 조 ("회원"의 의무)</h4>
					          <ol class="sections">
					            <li class="sections__section">①"회원"은 다음 행위를 하여서는 안 됩니다.
					              <ol class="sections">
					                ...
					                <li class="sections__section">4.	4."회사"가 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시 </li>
					                <li class="sections__section">5.	5."회사"와 기타 제3자의 저작권 등 지적재산권에 대한 침해 </li>
					                <li class="sections__section">6.	6."회사" 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위 </li>
					                <li class="sections__section">7.	7.외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 "서비스"에 공개 또는 게시하는 행위 </li>
					                <li class="sections__section">8.	8.회사의 동의 없이 영리를 목적으로 "서비스"를 사용하는 행위 </li>
					        ...
					        <div class="article">
					          <h4 class="article__title">제 12 조 ("서비스"의 제공 등)</h4>
					          <ol class="sections">
					            <li class="sections__section">①회사는 회원에게 아래와 같은 서비스를 제공합니다.
					              <ol class="sections">
					                ...
					                <li class="sections__section">6.	6.기타 "회사"가 추가 개발하거나 다른 회사와의 제휴계약 등을 통해 "회원"에게 제공하는 일체의 서비스 </li>
					              </ol>
					            </li>
					        ...
					        <div class="article">
					          <h4 class="article__title">제 13 조 ("서비스"의 변경)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 14 조 (정보의 제공 및 광고의 게재)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 15 조 ("게시물"의 저작권)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 16 조 ("게시물"의 관리)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 17 조 (권리의 귀속)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          ...
					          <ol class="sections">
					            ...
					            <li class="sections__section">②"회원"이 계약을 해지할 경우, 관련법 및 개인정보취급방침에 따라 "회사"가 회원정보를 보유하는 경우를 제외하고는 해지 즉시 "회원"의 모든 데이터는 소멸됩니다. </li>
					        ...
					        <div class="article">
					          <h4 class="article__title">제 20 조 (이용제한 등)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 21 조 (책임제한)</h4>
					          <ol class="sections">
					        ...
					        <div class="article">
					          <h4 class="article__title">제 22 조 (준거법 및 재판관할)</h4>
					          <ol class="sections">
					    ...
					    <li class="terms_bx terms_service lineT">
					    	<ul class="termsCheckStyle">
					    		<li>
					    			<span class="input_chk">
								      <input type="checkbox" id="termsPrivacy" name="termsPrivacy" onClick="viewTerms();clickcr(this, 'tos.service', '', '', event);" class="chk">
								      <label id="termsServiceLb" for="termsPrivacy">개인정보수집 및 이용동의<span class="terms_choice">(필수)</span></label>
								      <button type="button" class="btnStyle1_2 termsBtn" onClick="open_terms();" value="약관열기">약관열기</button>
								    </span>
								</li>
					    		<li><p class="txt_pointR">* 이용약관과 개인정보 수집 및 이용에 대한 안내를 모두 동의해주세요.</p></li>
					    	</ul>
					    </li>
					  </ul>
					</div>
					...
					<!-- 기본정보입력 -->
					<h3 class="joinTitleStyle mgt40">기본정보입력<span class="txt_pointR">* 필수입력정보입니다.</span></h3>
					<div class="authBox">
						<table class="Main_Board mgt10 mgb10" summary="기본정보입력 (아이디, 비밀번호, 비밀번호 재확인 등)" >
					    	...
					    	<tbody>
					    		<tr>
									<th scope="row"><label for="insertID">아이디<span class="txt_pointR">*</span></label></th>
								  	<td class="join_value">
								  		<label><input type="text" id="insertID" class="valueStyle02" placeholder="6~20자의 영문, 숫자와 특수문자(_)만 사용 가능합니다."/></label>
								  		<p class="txtStyle01 txt_pointB">사용가능한 아이디 입니다</p>
								  	</td>
								</tr>
								<tr>
									<th scope="row"><label for="insertPassword">비밀번호<span class="txt_pointR">*</span></label></th>
								  	<td class="join_value">
								  		<label><input type="text" id="insertPassword" class="valueStyle02" placeholder="8~20자리 영문, 숫자, 특수문자 중 2가지 이상 조합하여 사용하시기 바랍니다."/></label>
								  		<p class="txtStyle01 txt_pointB">사용가능한 비밀번호 입니다</p>
								  	</td>
								</tr>
								<tr>
									<th scope="row"><label for="checkPassword">비밀번호 재확인<span class="txt_pointR">*</span></label></th>
								  	<td class="join_value2">
								  		<label><input type="text" id="checkPassword" class="valueStyle02" /></label>
								  		<p class="txtStyle01 txt_pointR">비밀번호가 일치하지 않습니다</p>
								  	</td>
								</tr>
								<tr class="addInfoinsertST2">
									<th scope="row"><label for="insertNM">이름<span class="txt_pointR">*</span></label></th>
								  	<td><label><input type="text" id="insertNM" class="valueStyle02" /></label></td>
								</tr>
								<tr>
									<th scope="row" class="join_title"><label for="insertBirth">생년월일<span class="txt_pointR">*</span></label></th>
								  	<td class="join_value">
								  		<label><input type="text" id="insertBirth" class="valueStyle02 mgt10" placeholder="생년월일은 6자리로 입력해주세요. ex) YYMMDD"/></label>
								  		<p class="txtStyle01 txt_pointR">생년월일을 정확히 입력해 주세요</p>
								  	</td>
								</tr>
								<tr class="insertInfo02">
									<th scope="row"><label for="insertPhone2">휴대폰 번호<span class="txt_pointR">*</span></label></th>
									<td class="join_value">
										<label>
											<select id="insertPhone2">
											   <option>010</option>
										       <option>011</option>
										       <option>016</option>
										       <option>017</option>
									    ...
									    <label><input type="text" id="insertPhone2" placeholder="'-'없이 입력" /></label>
									    <label><button type="button" class="" value="인증번호 전송">인증번호 전송</button></label>
									    <p class="txtStyle01 txt_pointB">인증번호가 전송되었습니다.</p>
									</td>
								</tr>
								<tr class="insertAutInfo03">
								  <th scope="row"><label for="insertAuthNum">인증번호입력<span class="txt_pointR">*</span></label></th>
								  <td>
								  	<label><input type="text" id="insertAuthNum" class="valueStyle05" />
								  	<button type="button" class="confirmAuthNum" value="확인">확인</button></label>
								  	<span class="txtStyle01 txt_pointR">남은시간 (1:00)</span>
								  	<p class="txtStyle01 txt_pointR">인증번호를 확인하고 다시 입력해 주세요.</p>
									<p class="txtStyle01 txt_pointB">인증번호가 확인 되었습니다.</p>
									<ul class="itemList3 mgb20">
			                        	<li><input type="radio" id="phone2" class="radioST" checked="checked" /><span>SMS 수신</span></li>
			                            <li><input type="radio" id="email" class="radioST" /><span>SMS 수신거부</span></li>
		                            </ul>
								  </td>
								</tr>
								<tr class="addInfoinsertST2">
								  <th scope="row"><label for="inserEmail">이메일<span class="txt_pointR">*</span></label></th>
								  <td>
								  	<div class="mailStyle"><label><input type="text" id="inserEmail" /><span>@</span><input type="text" id="inserEmail2" /></label></div>
								  	<p class="txtStyle01 txt_pointR">잘못된 이메일 형식입니다. 다시입력해 주세요.</p>
									<ul class="itemList3">
			                        	<li><label><input type="radio" id="phone2" class="radioST" checked="checked" /><span>E-mail 수신</span></label></li>
			                            <li><label><input type="radio" id="email" class="radioST" /><span>E-mail 수신거부</span></label></li>
		                            </ul>
								  </td>
								</tr>
								<tr class="addressStyle">
								  <th scope="row"><label for="zipcode mgt10">우편번호/주소<span class="txt_pointR">*</span></label></th>
								  <td>
								  	<ul class="addInfoStyleU">
								  		<li class="addInfo1"><label><input type="text" id="zipcode" class="valueStyle05" /></label><button type="button" id="confirmZipcodeNum" value="우편번호 검색">우편번호 검색</button></li>
								  		<li><label><input type="text" id="adress" class="valueStyle02" /></label></li>
								  		<li><label><input type="text" id="adress2" class="valueStyle02" /></label></li>
								  	</ul>
								  </td>
								</tr>
					    	</tbody>
					...
					<!-- 추가정보입력 -->
					<h3 class="joinTitleStyle mgt40">추가정보입력<span>추가정보를 입력하시면 입력하신 정보에 따라 회원님에게 맞춤 서비스가 제공됩니다.</span></h3>
					<div class="authBox">
					   	<!-- 추가정보 테이블 -->
						<table class="Main_Board mgt10 mgb10" summary="추가정보입력 (소속회사. 경력내용)">
					       ...
					       <tbody>
					           <tr>
					               <th><label for="cpnNm">소속회사</label></th>
					               <td><input type="text" id="cpnNm" class="valueStyle02" value="" placeholder="회사선택은 셀렉트박스가 아니라 자동완성검색 방식으로 등록변경" /></td>
					           </tr>
					           <tr class="careerStyle">
					               <th><label for="career">경력내용</label></th>
					               <td class="join_value1">
							           <ul class="addInfoStyleU">
								           <li><input type="text" id="career" class="valueStyle05" value="" />
								           <input type="text" class="input_date" value="2016-04" title="시작일선택" /><button type="button" class="btn_calendar"><em>날짜선택</em></button><span>~</span><input type="text" class="input_date mgl6" value="2016-04" title="종료일선택" /><button type="button" class="btn_calendar"><em>날짜선택</em></button>
								           <button type="button" class="btnStyle2"><strong>추가</strong></button></li>
								           <li><input type="text" id="" class="valueStyle05" value="" />
								           <input type="text" class="input_date" value="2016-04" title="시작일선택" /><button type="button" class="btn_calendar"><em>날짜선택</em></button><span>~</span><input type="text" class="input_date mgl6" value="2016-04" title="종료일선택" /><button type="button" class="btn_calendar"><em>날짜선택</em></button>
								           <button type="button" class="btnStyle2"><strong>삭제</strong></button></li>
								           <li><p class="txtStyle01 txt_pointR">기간을 다시 입력해 주세요.</p></li>
							           </ul>

					               </td>
					           </tr>
					           <tr class="addInfoinsertST">
					               <th><label for="majorType">전공분야</label></th>
					               <td>
						               <ul class="addInfoStyleU mgb20">
						               	<li>
						                	<select id="majorType" class="select_Value">
											   <option>대분류</option>
										       <option></option>
										       <option></option>
										       <option></option>
											...
											<select id="majorType2" class="select_Value">
											   <option>중분류</option>
										       <option></option>
										       <option></option>
										       <option></option>
						               		...
						               		<select id="majorType3" class="select_Value">
											   <option>소분류</option>
										       <option></option>
										       <option></option>
										       <option></option>
						                 	...
						                 	<label><button type="button" class="btnStyle2"><strong>추가</strong></button></label>
						                 </li>
						               	 <li>
						                 	<select id="majorType" class="select_Value">
											   <option>대분류</option>
											...
											<select id="majorType2" class="select_Value">
						                 	...
						                 	<label><button type="button" class="btnStyle2"><strong>삭제</strong></button></label>
						                 </li>
						               </ul>
						               </label>
					               </td>
					           </tr>
					           <tr class="addInfoinsertSTs">
					               <th><label for="interestCpn">관심기업</label></th>
					               <td>
						               <ul class="addInfoStyleU mgt20">
						               	 <li>
						                 	<label>
							               		<select id="interestCpn" class="select_Value">
												   <option>대분류</option>
											       <option></option>
											       <option></option>
											       <option></option>
											...
											<label><input type="text" class="valueStyle04" value="" id="" /></label>
						                 	<label><button type="button" class="btnStyle2"><strong>추가</strong></button></label>
						                 </li>
						                 <li>
						                 	<label>
					...
					<!-- 계좌정보입력 -->
					<h3 class="joinTitleStyle mgt40">계좌정보입력<span>파트너회원으로 승급 후, 성과급 지급을 위한 계좌정보입니다. 추후 수정, 등록이 가능합니다.</span></h3>
					<div class="authBox">
					   	<!-- 계좌번호 테이블 -->
						<table class="Main_Board mgt10 mgb20" summary="계좌정보입력 (은행/예금주. 계좌번호)">
						  	<caption>계좌정보입력</caption>
						      <colgroup>
						          <col width="22%" />
						          <col width="*" />
						      </colgroup>
						      <tbody>
						          <tr>
						              <th><label for="selectBank">은행/예금주</label></th>
						              <td class="valueStyle03">
						               	<label>
										...
										<label for="accountHolder"><input type="text" value="" placeholder="기본적으로 본인이름이 자동입력되어있음" /></label>
						               	<p class="txt_pointR mgb5">주의사항 : 추후 파트너 회원 승급 후 성과급 지급 시 예금주와 회원명이 다를 경우 성과급 지급이 지연되거나, 불리하게 작용할 수 있습니다.</p>
						              </td>
						          </tr>
						          <tr>
						              <th><label for="accountNum">계좌번호</label></th>
						              <td><label><input type="text" id="accountNum" class="valueStyle02" /></label></td>
						          </tr>
						      </tbody>
						  </table>
						  <!--//계좌번호 테이블//-->
					...
					<div class="btn_area mgt40">
					  <label for="joinUs"><button type="button"><strong>가입하기</strong></button></label>
					</div>
					<!--//버튼//-->
				</div>
			</div>
